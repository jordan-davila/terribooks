            ...
            <div class="card-content px-8 py-6 text-xxs font-bold uppercase">
                ...
                <div class="input-row grid grid-cols-1 gap-2 mb-3">
                    ...
                    <div class="input-col" v-if="$page.props.availableRoles.length > 0">
                        <label>Role</label>
                        <div
                            class="relative flex z-0 mt-2 border border-gray-200 rounded-lg cursor-pointer overflow-hidden"
                        >
                            <button
                                type="button"
                                class="relative px-4 py-3 flex justify-start items-center w-full border-r border-gray-200 last:border-r-0"
