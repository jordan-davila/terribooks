        ...
        <div class="popper rounded-md shadow-lg w-48 bg-white overflow-hidden">
            <div class="rounded-md ring-1 ring-black ring-opacity-5 text-xxs uppercase">
                ...
                <form @submit.prevent="logout">
                    <button
                        type="submit"
                        class="block px-6 py-2 w-full text-left uppercase leading-5 text-gray-300 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out"
                    >
                        Logout
                    </button>
                </form>
