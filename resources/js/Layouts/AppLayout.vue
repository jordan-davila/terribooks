                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <template>
                                                ...
                                                <jet-dropdown-link :href="route('teams.show', $page.props.user.current_team)" v-if="$page.props.user.belongsToAnyTeam">
                                                    ...
                                                    <form @submit.prevent="switchToTeam(congregation)" :key="congregation.id">
                                                        <jet-dropdown-link as="button">
                                                            <div class="flex items-center">
                                                                <svg v-if="congregation.id == $page.props.user.current_team_id" class="mr-2 h-5 w-5 text-green-400" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <template>
                                ...
                                <!-- Team Settings -->
                                <jet-responsive-nav-link :href="route('teams.show', $page.props.user.current_team)" :active="route().current('teams.show')" v-if="$page.props.user.belongsToAnyTeam">
                                    Team Settings
                                </jet-responsive-nav-link>
